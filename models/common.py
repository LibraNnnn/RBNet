...
class RBSPPCSPC(SPPCSPC):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5, k=(5, 9, 13)):
        super().__init__(c1, c2, n, shortcut, g, e, k)
        c_ = int(2 * c2 * e)  # hidden channels
        self.cv1 = RobustConv(c1, c_, 1, 1)
        self.cv2 = RobustConv(c1, c_, 1, 1)
        self.cv3 = RobustConv(c_, c_, 3, 1)
        self.cv4 = RobustConv(c_, c_, 1, 1)
        self.cv5 = RobustConv(4 * c_, c_, 1, 1)
        self.cv6 = RobustConv(c_, c_, 3, 1)
        self.cv7 = RobustConv(2 * c_, c2, 1, 1)
        
class RSPPFCSPC(nn.Module):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5, k=5):
        super(RSPPFCSPC, self).__init__()
        c_ = int(2 * c2 * e)  # hidden channels
        self.cv1 = RobustConv(c1, c_, 1, 1)
        self.cv2 = RobustConv(c1, c_, 1, 1)
        self.cv3 = RobustConv(c_, c_, 3, 1)
