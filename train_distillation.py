...
from utils.loss import ComputeLoss, ComputeLossOTA , compute_distillation_output_loss
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='runs/train_VOC/v7-Baseline/weights/best.pt', help='initial weights path')

    parser.add_argument('--t_weights', type=str, default='runs/train_VOC/v7-Teacher/weights/best.pt', help='initial tweights path')
    parser.add_argument('--dist_loss', type=str, default='l2', help='using kl/l2 loss in distillation')
    parser.add_argument('--temperature', type=int, default=20, help='temperature in distillation training')
    parser.add_argument('--distill', action='store_true',default=True, help='distillation training')
    ...
    parser.add_argument('--hyp', type=str, default='data/hyp.scratch.p6-distill.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--project', default='runs/train_VOC', help='save to project/name')
    parser.add_argument('--entity', default=None, help='W&B entity')
    parser.add_argument('--name', default='v7-baseline_dis', help='save to project/name')
